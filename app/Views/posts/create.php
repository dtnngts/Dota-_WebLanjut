                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($validation->hasError('judul')) : ?>
                                            <div class="invalid-feedback">
                                                <?php $validation->getError('judul'); ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="judul">Slug</label>
                                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="slug" name="slug">
                                        <?php if ($validation->hasError('slug')) : ?>
                                            <div class="invalid-feedback">
                                                <?php $validation->getError('slug'); ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="judul">Kategori Postingan</label>
                                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="kategori" name="kategori">
                                        <?php if ($validation->hasError('kategori')) : ?>
                                            <div class="invalid-feedback">
                                                <?php $validation->getError('kategori'); ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="judul">Author</label>
                                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="author" name="author" >
                                        <?php if ($validation->hasError('author')) : ?>
                                            <div class="invalid-feedback">
                                                <?php $validation->getError('author'); ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
